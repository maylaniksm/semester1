...
int main () {
	...
	//char arrNamaBuku[7][100] = {"Pemograman C","Pemograman PHP","Pemograman Java","Pemograman Phyton","Pemograman Laravel","Pemograman React","Pemograman Node"};
